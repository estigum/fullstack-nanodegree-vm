   This is my version of the SwissTournament for the fullstack nanodegree. It supports the following
   ...
   tournament.sql - Includes tables to store the date and  stored procedures for retrieving data
   Tables
   1. Players - This has the list of players in the tournament
   2. SwissTournament - List of tournaments that are going on.
   3. TorunamentResults - This is the results for the tournmanents.
   ...
   3. register_swiss_tournament - This will register a new tournament
   4. report_match - Will report results of a match for a given tournament
   ...
   tournaments -  You pass in 0 it will give you overall for all the tournaments that happened.
   7. get_swiss_pairings - Returns the pairings for a given tournament

   Python files
   1. tournament.py - This contains all the database calls
   2. tournament_test.py - This is the test cases for tournament.py
   2. swisstournament.py - this is the file that runs the tournaments. It has the main method and a class to
   run the tournaments.
   ...
   Config settings.
   1. [run_mode] section
      A. tournaments - list of tournaments. Comma seperated
      B. player_file - the player file to use
      C. web_support - I will always genrate html files, but you can have the browser bring them up.  If you want that set this
   ...
   2. [logging]
      A. mode - what you want to output.  Differnt levels.
